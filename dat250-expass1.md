[Docker repo](https://hub.docker.com/r/hesol/dat250)
...
importing the project into the IDE (IntelliJ) proved the environment worked and that the project itself was built correctly
